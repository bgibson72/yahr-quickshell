...
Rectangle {
    ...
    property int notificationCount: notificationService ? notificationService.notifications.length : 0
    property bool hasNotifications: notificationCount > 0
    property bool dndMode: notificationService ? notificationService.dndEnabled : false
