...
Rectangle {
    ...
    Row {
        ...
        Item {
            width: systemTray.showNetworkDetails ? 100 : 35
            height: 32
            ...
            Row {
                ...
                Text {
                    ...
                    font.pixelSize: 16
                    color: systemTray.networkType === "disconnected" ? ThemeManager.accentRed : ThemeManager.accentBlue
                }
                
                Text {
                    anchors.verticalCenter: parent.verticalCenter
                    text: systemTray.networkType === "wifi" ? systemTray.signalStrength + "%" : "LAN"
        ...
        Item {
            ...
            Row {
                ...
                Text {
                    ...
                    font.family: "MapleMono NF"
                    font.pixelSize: 11
                    color: systemTray.muted ? ThemeManager.border0 : ThemeManager.fgPrimary
