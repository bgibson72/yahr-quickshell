...
Rectangle {
    ...
    Row {
        ...
        Rectangle {
            width: 35
            height: 32
            color: networkMouseArea.pressed ? Qt.darker(ThemeManager.surface1, 1.2) : 
                   (networkMouseArea.containsMouse ? ThemeManager.surface1 : ThemeManager.surface0)
            radius: 6
        ...
        Rectangle {
            width: 35
            height: 32
            color: audioMouseArea.pressed ? Qt.darker(ThemeManager.surface1, 1.2) : 
                   (audioMouseArea.containsMouse ? ThemeManager.surface1 : ThemeManager.surface0)
            radius: 6
        ...
        Rectangle {
            id: batteryRect
            width: showDetails ? 120 : 35  // Expand to show full details
            height: 32
            color: batteryMouseArea.pressed ? Qt.darker(ThemeManager.surface1, 1.2) : 
                   (batteryMouseArea.containsMouse ? ThemeManager.surface1 : ThemeManager.surface0)
            radius: 6
            ...
            Row {
                ...
                Text {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    visible: batteryRect.showDetails
                    opacity: batteryRect.showDetails ? 1.0 : 0.0
