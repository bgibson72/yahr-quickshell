...
Item {
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            // Quick access buttons row - slides in from the right
            RowLayout {
                id: quickAccessRow
                spacing: 4
                ...
                // Slide animation - starts collapsed to the left, slides right when expanded
                transform: Translate {
                    x: drawer.expanded ? 0 : -quickAccessRow.width
