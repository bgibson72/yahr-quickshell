                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            height: 40
                            radius: 8
                            color: applyScreenshotMouseArea.containsMouse ? ThemeManager.accentGreen : ThemeManager.surface1
                            border.width: 2
                            border.color: ThemeManager.accentGreen
                            ...
                            Text {
                                ...
                                font.pixelSize: 14
                                font.weight: Font.Bold
                                color: applyScreenshotMouseArea.containsMouse ? ThemeManager.bgBase : ThemeManager.accentGreen
                            }
                            
                            MouseArea {
                                id: applyScreenshotMouseArea
                                anchors.fill: parent
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
