    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                height: 40
                radius: 8
                color: applyButtonMouseArea.containsMouse ? ThemeManager.accentGreen : ThemeManager.surface1
                border.width: 2
                ...
                Text {
                    ...
                    font.pixelSize: 14
                    font.weight: Font.Bold
                    color: applyButtonMouseArea.containsMouse ? ThemeManager.bgBase : ThemeManager.accentGreen
                }
