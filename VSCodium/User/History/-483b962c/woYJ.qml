...
PanelWindow {
    ...
    function loadCurrentTheme() {
        ...
        const themeFile = Quickshell.env("HOME") + "/.config/quickshell/.current-theme"
    ...
    Process {
        id: themeProcess
        running: false
        command: ["cat", Quickshell.env("HOME") + "/.config/quickshell/.current-theme"]
            ...
            Rectangle {
                ...
                GridView {
                    ...
                    delegate: Rectangle {
                        ...
                        color: mouseArea.containsMouse ? ThemeManager.accent : ThemeManager.surface2
                        radius: 12
