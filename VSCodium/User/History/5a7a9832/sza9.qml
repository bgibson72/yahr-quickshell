...
MouseArea {
    ...
    Rectangle {
        ...
        color: popupVisible ? "red" : (clockArea.containsMouse ? ThemeManager.surface1 : ThemeManager.surface0)
        radius: 6
        border.width: popupVisible ? 3 : 0
        border.color: "yellow"
    ...
    onClicked: {
        console.log("Clock clicked! popupVisible:", popupVisible)
        if (popupVisible) {
