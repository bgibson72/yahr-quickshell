...
Rectangle {
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        function updateCalendar() {
                            ...
                            // Clear existing days
                            for (let i = dayRepeater.count - 1; i >= 0; i--) {
                                dayRepeater.itemAt(i).destroy()
                            }
                            ...
                            for (let i = 0; i < firstDay; i++) {
                                dayComponent.createObject(calendar, { dayText: "", isCurrentMonth: false })
                            }
                            ...
                            for (let day = 1; day <= daysInMonth; day++) {
                                const isToday = (currentMonth === new Date().getMonth() && 
                                               ...
                                               day === today)
                                dayComponent.createObject(calendar, { 
    ...
    Component {
        ...
        Rectangle {
            ...
            color: isToday ? ThemeManager.accentBlue : 
            ...
            Text {
                ...
                color: isToday ? ThemeManager.surface0 : 
                       (isCurrentMonth ? ThemeManager.fgPrimary : ThemeManager.fgTertiary)
                text: dayText
            }
