...
use relm4::{ComponentParts, ComponentSender, SimpleComponent, Controller, RelmWidgetExt, Component, ComponentController};
    ...
    fn update(&mut self, msg: Self::Input, sender: ComponentSender<Self>) {
        match msg {
            ...
            AppMsg::UpdateColorGrid => {
                // This message is used to trigger a UI update after color cards are added
            }
        }
    }
}
