...
impl SimpleComponent for App {
    ...
    fn post_view() {
        // This is called after the view is created, we'll update colors manually
    }
}

impl App {
    fn update_colors(&self, widgets: &mut AppWidgets, sender: &ComponentSender<Self>) {
        ...
        for color in &self.colors {
            ...
            widgets.color_grid.append(&card);
        }
    }
}
