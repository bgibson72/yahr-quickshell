...
use relm4::{ComponentParts, ComponentSender, SimpleComponent, Controller, RelmWidgetExt};
...
impl SimpleComponent for App {
            ...
            gtk::Box {
                ...
                gtk::Box {
                    ...
                    gtk::ScrolledWindow {
                        ...
                        #[wrap(Some)]
                        set_child = #[local_ref] &color_grid -> gtk::Box {
                            set_orientation: Orientation::Horizontal,
                            set_spacing: 16,
                            set_margin_all: 16,
    ...
    fn update(&mut self, msg: Self::Input, sender: ComponentSender<Self>) {
        match msg {
                ...
                if let Some(ref path) = self.current_image {
                    ...
                    match ColorExtractor::extract_from_path(path, self.color_count) {
                        Ok(colors) => {
                            ...
                            // Trigger UI update to show the cards
                            sender.input(AppMsg::UpdateColorGrid);
                        }
                        Err(e) => {
            ...
            AppMsg::UpdateColorGrid => {
                // This message is used to trigger a UI update
            }
        }
    }
    ...
    fn update_view(&self, widgets: &mut Self::Widgets, _sender: ComponentSender<Self>) {
        ...
        while let Some(child) = widgets.color_grid.first_child() {
            widgets.color_grid.remove(&child);
        }

        // Add all color cards to the grid
        for controller in &self.color_cards {
            widgets.color_grid.append(controller.widget());
        }
    }
}
