                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            Rectangle {
                                anchors.fill: parent
                                radius: 8
                                color: themeSwitcher.selectedIndex === index 
                                    ? ThemeManager.accentBlue
                                    : (themeMouseArea.containsMouse ? Qt.rgba(ThemeManager.accentBlue.r, ThemeManager.accentBlue.g, ThemeManager.accentBlue.b, 0.3) : "transparent")
                            }
