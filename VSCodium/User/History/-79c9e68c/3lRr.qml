...
ShellRoot {
    ...
    NotificationService {
        ...
        Component.onCompleted: {
            console.log("✅ NotificationService ready, exposing to shell")
            console.log("✅ shellRoot.notificationService is:", shellRoot.notificationService)
        }
    }
    
    Component.onCompleted: {
        console.log("✅ ShellRoot completed, notificationService is:", notificationService)
    }
    
    property var notificationServiceReady: notificationService
