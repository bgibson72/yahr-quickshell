            ...
            ListView {
                ...
                model: ListModel {
                    ...
                    ListElement {
                        appIcon: ""
                        appName: "Kitty"
                        appDescription: "Terminal Emulator"
                        appCommand: "kitty"
                        visible: true
                    }
                    ListElement {
                    ...
                    ListElement {
                        ...
                        appDescription: "Configuration"
                        appCommand: "gnome-control-center"
                        visible: true
                    }
                }
