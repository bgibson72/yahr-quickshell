        ...
        Rectangle {
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    height: 48
                    color: (index === root.selectedIndex || mouseArea.containsMouse) ? ThemeManager.accentBlue : "transparent"
                    radius: 8
                    ...
                    Row {
                        ...
                        Item {
                            ...
                            Rectangle {
                                anchors.fill: parent
                                color: (index === root.selectedIndex || mouseArea.containsMouse) ? ThemeManager.bgBase : ThemeManager.surface2
                                radius: 8
                                ...
                                Text {
                                    ...
                                    font.pixelSize: 22
                                    color: (index === root.selectedIndex || mouseArea.containsMouse) ? ThemeManager.accentBlue : ThemeManager.fgPrimary
                                }
                            }
                        }
                        ...
                        Text {
                            ...
                            font.family: "MapleMono NF"
                            font.pixelSize: 14
                            font.weight: (index === root.selectedIndex || mouseArea.containsMouse) ? Font.DemiBold : Font.Medium
                            color: (index === root.selectedIndex || mouseArea.containsMouse) ? ThemeManager.bgBase : ThemeManager.fgPrimary
