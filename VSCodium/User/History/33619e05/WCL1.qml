...
Rectangle {
    ...
    // Left highlight bar with padding to avoid rounded corners
    Rectangle {
        anchors.left: parent.left
        anchors.top: parent.top
        anchors.topMargin: 6  // padding from top curved corner
        anchors.bottom: parent.bottom
        anchors.bottomMargin: 6  // padding from bottom curved corner
        width: 3
        color: ThemeManager.accentBlue
        radius: 1.5  // slightly rounded ends
