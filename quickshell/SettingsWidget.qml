        ...
        Item {
            ...
            ColumnLayout {
                ...
                Repeater {
                    model: 10
                    Rectangle {
                        property int stackIdx:   [0, 1, 2, 4, 5, 3, 6, 9, 8, 7][index]
                        property string tabIcon: ["\uf013", "\uf030", "\uf0c9", "\uf1fc", "\uf03e", "\uf359", "\uf108", "\uf2bd", "\uf2d0", "\uf05a"][index]
                        property string tabLabel: ["Quickshell", "Screenshots", "Bar", "Theme", "Wallpaper", "Hyprland", "Monitors", "SDDM", "Dock", "About"][index]
                                            ...
                                            Rectangle {
                                                ...
                                                MouseArea {
                                                    ...
                                                    onClicked: {
                                                        ...
                                                        var user = Quickshell.env("USER") || "bryan"
                                                        sddmAvatarCopier.command = ["sh", "-c",
                                                            "cp '" + imgPath + "' ~/.face.icon && " +
                                                            "cp '" + imgPath + "' ~/.face 2>/dev/null && " +
                                                            "sudo -n cp '" + imgPath + "' /usr/share/sddm/faces/" + user + ".face.icon && " +
                                                            "echo OK || echo FAIL"]
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                sddmThemeWriter.command = ["sh", "-c",
                                                    ...
                                                    "sudo -n tee /usr/share/sddm/themes/yahr-theme/theme.conf > /dev/null && echo OK || echo FAIL"]
