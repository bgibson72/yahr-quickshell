...
# Sync Firefox Theme with Current Hyprland Theme
...
cat > "$USER_CSS" << EOF
/* Firefox Theme - Auto-synced with Hyprland Theme: $theme_name */
...
/* Firefox Content Theme - Auto-synced with Hyprland Theme: $theme_name */
